...
**This library allows you to use the XM SendSecure Web API via Java.**
...
- The XM SendSecure solution, provided by [XMedius](https://www.xmedius.com?source=sendsecure-java) (demo accounts available on demand)
